...
export class PolygonalChain {
	...
	/**
	 * @param data PIXI.Point data for polygon chains. Either a list of points for a single chain, or a list of chains.
	 */
...
export class Emitter {
	...
	/**
	 * An array of PIXI PIXI.Texture objects.
	 */
	particleImages: any[];
	/**
	...
	*/
	 ...
	 *                       into textures via PIXI.Texture.fromImage().
...
/**
 * A semi-experimental PIXI.Container that uses a doubly linked list to manage children instead of an
 ...
 * edge cases well if used as a complete PIXI.Container replacement.
 */
export class LinkedListContainer extends PIXI.Container {
	 ...
	 */
	addChildBelow<T extends PIXI.DisplayObject>(child: T, relative: PIXI.DisplayObject): T;
	/**
	 ...
	 * @return The child that was added.
	 */
	addChildAbove<T extends PIXI.DisplayObject>(child: T, relative: PIXI.DisplayObject): T;
 ...
 */
export class Particle extends PIXI.Sprite implements LinkedListChild {
	/**
	 ...
	 *            Textures via PIXI.Texture.from().
...
export class PathParticle extends Particle {
	 ...
	 * @param art The array of art data. For Particle, it should be an array of
	 *            Textures. Any strings in the array will be converted to
	 *            Textures via PIXI.Texture.fromImage().
	 * @return The art, after any needed modifications.
	 */
 ...
 *         //frames. Any strings will be converted to Textures with PIXI.Texture.from().
 *         //Instances of PIXI.PIXI.Texture will be used directly.
 *         "animFrame1.png",
...
export class AnimatedParticle extends Particle {
	/**
	 * PIXI.Texture array used as each frame of animation, similarly to how MovieClip works.
	 */
	private textures;
	/**
	 ...
	 * @param art An array of PIXI.PIXI.Texture objects for this animated particle.
	 */
