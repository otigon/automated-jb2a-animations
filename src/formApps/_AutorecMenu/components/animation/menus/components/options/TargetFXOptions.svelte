    ...
    <TJSSvgFolder {folder}>
        ...
        <div class="aa-options" style="justify-items:center">
            ...
            <div class="flexcol" style="grid-row: 1 / 2; grid-column: 1 / 2;">
                ...
                >
                <label for="Persist Target {animation._data.id}" class="aa-cblabel"
                    >{isPersistent}</label
                >
                <input
                    type="checkbox"
            ...
            <div class="flexcol" style="grid-row: 1 / 2; grid-column: 2 / 3;">
                ...
                <label for="Below Target {animation._data.id}" class="aa-cblabel"
                    >{aboveBelow}</label
                >
                <input
                    type="checkbox"
            ...
            >
                ...
                >
                <label for="Vis Target {animation._data.id}" class="aa-cblabel"
            ...
            >
                ...
                <label for="Alpha Target {animation._data.id}" class="aa-cblabel"
                    >{bindAlpha}</label
                >
                <input
                    type="checkbox"
            ...
            <div class="flexcol" style="grid-row: 2 / 3; grid-column: 1 / 2;">
                ...
                <label for="Mask Target {animation._data.id}" class="aa-cblabel"
                    >{maskLabel}</label
                >
                <input
                    type="checkbox"
