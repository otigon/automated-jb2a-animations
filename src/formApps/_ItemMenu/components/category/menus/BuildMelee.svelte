<script>
    ...
    import MeleeOptions from "../../../../_AutorecMenu/components/animation/components/options/MeleeOptions.svelte";
    ...
    import MeleeSwitch from "../../../../_AutorecMenu/components/animation/components/MeleeSwitch.svelte";
