...
async function buildBlessFile(jb2a, handler) {
    ...
    const file01 = `autoanimations.bless.static.${color}.intro`;
    const file02 = `autoanimations.bless.static.${color}.loop`;
    const ctaFile01 = jb2a.bless.static[color]["intro"];
    const ctaFile02 = jb2a.bless.static[color]["loop"];
