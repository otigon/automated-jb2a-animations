...
export async function teleportation(handler, animationData) {
    ...
    async function deleteTemplatesAndMove() {
        ...
        if (data.start) {
            ...
            startEffect.elevation(data.start.options.isAbsolute ? data.start.options.elevation : sourceToken.document.elevation + data.start.options.elevation)
        ...
        if (data.between) {
            ...
            betweenEffect.elevation(data.between.options.isAbsolute ? data.between.options.elevation : sourceToken.document.elevation + data.between.options.elevation)
        ...
        if (data.end) {
            ...
            endEffect.elevation(data.end.options.isAbsolute ? data.end.options.elevation : sourceToken.document.elevation + data.end.options.elevation)
