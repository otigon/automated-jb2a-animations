...
export async function teleportation(handler, animationData) {
    ...
    async function deleteTemplatesAndMove() {
        ...
        if (data.start) {
            ...
            startEffect.elevation(handler.elevation(sourceToken, data.start.options.isAbsolute, data.start.options.elevation))
        ...
        if (data.between) {
            ...
            betweenEffect.elevation(handler.elevation(sourceToken, data.between.options.isAbsolute, data.between.options.elevation))
        ...
        if (data.end) {
            ...
            endEffect.elevation(handler.elevation(sourceToken, data.end.options.isAbsolute, data.end.options.elevation))
