...
AAITEMCHECK.melee = ['dagger', 'handaxe', 'rapier', 'sword', 'greatsword', 'lasersword', 'greatclub', 'greataxe', 'mace', 'spear', 'maul', '1hs', '2hs', '1hb', '2hb', '1hp', '2hs', 'unarmedstrike', 'flurryofblows']
...
AAITEMCHECKFREE.ranged = ['lasershot', 'bullet', 'bolt', 'arrow', 'snipe', 'rangelasersword', 'rangelasersworddb', 'rangedagger', 'rangehandaxe']

AAITEMCHECKFREE.spellattack = ['firebolt', 'rayoffrost', 'witchbolt', 'eldritchblast', 'scorchingray', 'disintegrate', 'guidingbolt', 'magicmissile']

AAITEMCHECKFREE.healing = ['curewounds', 'generichealing']
