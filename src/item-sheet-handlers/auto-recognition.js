export default class AUTORECOG {
    constructor () {
        ...
        this._greatsword = ["greatsword", game.i18n.format("AUTOANIM.itemGreatsword").toLowerCase()];
        
        this._sword = ["sword", game.i18n.format("AUTOANIM.itemSword").toLowerCase(), "scimitar", game.i18n.format("AUTOANIM.itemScimitar").toLowerCase()];
        
        this._greatclub = ["greatclub", game.i18n.format("AUTOANIM.itemGreatclub").toLowerCase()]
        
        this._greataxe = ["greataxe", "battleaxe", game.i18n.format("AUTOANIM.itemGreataxe").toLowerCase(), game.i18n.format("AUTOANIM.itemBattleaxe").toLowerCase()]
        ...
        this._handaxe = ["handaxe", game.i18n.format("AUTOANIM.itemHandaxe").toLowerCase()]
        ...
        this._rangejavelin = ["javelin", game.i18n.format("AUTOANIM.itemJavelin").toLowerCase()]
        ...
        this._firebolt = ["fire bolt", game.i18n.format("AUTOANIM.itemFireBolt").toLowerCase(), ]
        ...
        this._scorchingray = ["scorching ray", game.i18n.format("AUTOANIM.itemScorchingRay").toLowerCase()]
        ...
        this._creaturebite = ["bite", game.i18n.format("AUTOANIM.itemBite").toLowerCase()]
